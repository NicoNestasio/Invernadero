...
void BOARD_InitDHT22Pins(void) {
    /* 1. Relojes */
    CLOCK_EnableClock(kCLOCK_Iocon);
    CLOCK_EnableClock(kCLOCK_Swm);

    /* 2. Aspecto eléctrico: El DHT22 NECESITA pull-up */
    const uint32_t PIO0_14_config = (
        IOCON_PIO_MODE_PULLUP |
        IOCON_PIO_HYS_EN |
        IOCON_PIO_INV_DI |
        IOCON_PIO_OD_DI |
    ...
    IOCON_PinMuxSet(IOCON, 14, PIO0_14_config);

    /* 3. Switch Matrix: Ruteo MOVABLE */
    /* Según tu SDK, puede ser kSWM_T0_CAP_CHN0 o kSWM_CTIMER0_CAP0 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_CAP_CHN0, kSWM_PortPin_P0_14);
