...
#define BOARD_INITPINS_GREEN_LABEL "GREEN"                      /*!<@brief Label */
...
#define BOARD_INITPINS_RED_LABEL "RED"                        /*!<@brief Label */
...
#define BOARD_INITPINS_USER_LABEL "USER"    /*!<@brief Label */
#define BOARD_INITPINS_USER_NAME "USER"     /*!<@brief Identifier name */
                                            /* @} */

/*! @name PIO0_12 (number 4), USER
  @{ */
#define BOARD_INITPINS_USERB_PERIPHERAL PINT  /*!<@brief Device name: PINT */
#define BOARD_INITPINS_USERB_SIGNAL PINT      /*!<@brief PINT signal: PINT */
#define BOARD_INITPINS_USERB_PORT 0U          /*!<@brief PORT device name: 0U */
#define BOARD_INITPINS_USERB_PIN 12U          /*!<@brief 0U pin index: 12 */
#define BOARD_INITPINS_USERB_CHANNEL 1        /*!<@brief PINT PINT channel: 1 */
#define BOARD_INITPINS_USERB_PIN_NAME PIO0_12 /*!<@brief Pin name */
#define BOARD_INITPINS_USERB_LABEL "USER"     /*!<@brief Label */
#define BOARD_INITPINS_USERB_NAME "USERB"     /*!<@brief Identifier name */
                                              /* @} */

/*! @name ADC_0 (number 33), ADC
  @{ */
...
#define BOARD_INITPINS_ADC_LABEL "ADC"     /*!<@brief Label */
#define BOARD_INITPINS_ADC_NAME "ADC"      /*!<@brief Identifier name */
                                           /* @} */

/*! @name CAPT_X0 (number 9), CAPX
  @{ */
...
#define BOARD_INITPINS_CAPX_LABEL "CAPX"     /*!<@brief Label */
#define BOARD_INITPINS_CAPX_NAME "CAPX"      /*!<@brief Identifier name */
                                             /* @} */

/*! @name ACMP_I5 (number 42), CAPY
  @{ */
#define BOARD_INITPINS_CAPY_PERIPHERAL ACMP  /*!<@brief Device name: ACMP */
#define BOARD_INITPINS_CAPY_SIGNAL ACMP_IN5  /*!<@brief ACMP signal: ACMP_IN5 */
#define BOARD_INITPINS_CAPY_PIN_NAME ACMP_I5 /*!<@brief Pin name */
#define BOARD_INITPINS_CAPY_LABEL "CAPY"     /*!<@brief Label */
#define BOARD_INITPINS_CAPY_NAME "CAPY"      /*!<@brief Identifier name */
                                             /* @} */
