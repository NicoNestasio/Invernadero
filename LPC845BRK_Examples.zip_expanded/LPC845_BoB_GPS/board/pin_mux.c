...
- pin_list:
  ...
  - {pin_num: '39', peripheral: USART1, signal: TXD, pin_signal: PIO0_23/ADC_3/ACMP_I4}
  - {pin_num: '43', peripheral: USART1, signal: RXD, pin_signal: PIO0_22/ADC_4}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* USART1_TXD connect to P0_23 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_TXD, kSWM_PortPin_P0_23);

    /* USART1_RXD connect to P0_22 */
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_RXD, kSWM_PortPin_P0_22);
