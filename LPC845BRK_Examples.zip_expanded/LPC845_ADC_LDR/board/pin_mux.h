...
/*! @name ADC_8 (number 47), ADC_8/ LDR
  @{ */
#define BOARD_INITPINS_ADC_8_LDR_PERIPHERAL ADC0    /*!<@brief Device name: ADC0 */
#define BOARD_INITPINS_ADC_8_LDR_SIGNAL CH          /*!<@brief ADC0 signal: CH */
#define BOARD_INITPINS_ADC_8_LDR_CHANNEL 8          /*!<@brief ADC0 channel: 8 */
#define BOARD_INITPINS_ADC_8_LDR_PIN_NAME ADC_8     /*!<@brief Pin name */
#define BOARD_INITPINS_ADC_8_LDR_LABEL "ADC_8/ LDR" /*!<@brief Label */
#define BOARD_INITPINS_ADC_8_LDR_NAME "ADC_8_LDR"   /*!<@brief Identifier name */
                                                    /* @} */

/*! @name ADC_0 (number 33), ADC_0 / Potentiometer
  @{ */
#define BOARD_INITPINS_ADC_0_PERIPHERAL ADC0               /*!<@brief Device name: ADC0 */
#define BOARD_INITPINS_ADC_0_SIGNAL CH                     /*!<@brief ADC0 signal: CH */
#define BOARD_INITPINS_ADC_0_CHANNEL 0                     /*!<@brief ADC0 channel: 0 */
#define BOARD_INITPINS_ADC_0_PIN_NAME ADC_0                /*!<@brief Pin name */
#define BOARD_INITPINS_ADC_0_LABEL "ADC_0 / Potentiometer" /*!<@brief Label */
#define BOARD_INITPINS_ADC_0_NAME "ADC_0"                  /*!<@brief Identifier name */
                                                           /* @} */
